...
class TestOfRealm extends UnitTestCase {
    ...
    function testNewUrlInSameDirectoryDoesNotChangeRealm() {
        ...
        $this->assertTrue($realm->isWithin(
                new SimpleUrl('http://www.here.com/path/index.php')));
        $this->assertFalse($realm->isWithin(
                new SimpleUrl('http://www.here.com/index.php')));
    }
    ...
    function testNewUrlMakesRealmTheCommonPath() {
        ...
        $this->assertTrue($realm->isWithin(
                new SimpleUrl('http://www.here.com/path/here/index.php')));
        $this->assertTrue($realm->isWithin(
                new SimpleUrl('http://www.here.com/path/there/index.php')));
        $this->assertTrue($realm->isWithin(
                new SimpleUrl('http://www.here.com/path/index.php')));
        $this->assertFalse($realm->isWithin(
                new SimpleUrl('http://www.here.com/index.php')));
        $this->assertFalse($realm->isWithin(
                new SimpleUrl('http://www.here.com/paths/index.php')));
        $this->assertFalse($realm->isWithin(
